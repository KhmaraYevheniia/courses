...
radioElements.classList.add('radio-item');

let radioElementsRegionWrap = div.cloneNode();
radioElementsRegionWrap.classList.add('radio-region-wrap');

let radioElementsLanguageWrap = div.cloneNode();
radioElementsLanguageWrap.classList.add('radio-language-wrap');

let radioHeading = p.cloneNode();
radioHeading.textContent = 'Please choose the type of search:';
radioHeading.classList.add('radio-title');
...
selectHeading.classList.add('select-title');
...
const drawTableHeader = () => {
    ...
    th1.classList.add('th-sort');

    let th1DoubleArrow = div.cloneNode();
    th1DoubleArrow.innerHTML = '&#8597;';
    th1DoubleArrow.classList.add('arrow-double')
    ...
    th5.classList.add('th-sort');

    let th5DoubleArrow = div.cloneNode();
    th5DoubleArrow.innerHTML = '&#8597;';
    th5DoubleArrow.classList.add('arrow-double');
...
const drawTableBody = (data) => {
    ...
    data.forEach(countryData => {
        ...
        const countryImage = img.cloneNode();
